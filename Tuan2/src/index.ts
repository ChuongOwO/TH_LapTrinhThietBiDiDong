...
function simulateTask(name: string, time: number): Promise<{ name: string; result: string }> {
...
async function cau5() { 
    console.log("=====Cau 5====="); 
    const result = await simulateTask("Task 1", 1000);
...
async function cau7() {
    console.log("=====Cau 7=====");
    const result = await runRaceTasks();
